        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-5 md:col-start-8">
            ...
            <div className="space-y-6 text-lg text-black font-light leading-relaxed">
              ...
              <p>
                Noi am format o echipă de ingineri cu peste 15 ani de experiență, timp în care am învățat să implementăm design-ul cu soluțiile tehnice, folosind printre cele mai bune echipamente de pe piață pentru a ne asigura că rezultatul final este <span className="italic">pe măsura așteptărilor </span>.
              </p>
              <p>
